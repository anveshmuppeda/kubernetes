# **"Getting Started with AWS EKS Fargate: A Complete Guide to Serverless Kubernetes"**  
...
The following create-fargate-profile example creates an EKS Fargate Profile for a selector with a namespace.  
  ...
  aws eks create-fargate-profile \
    ...
    --fargate-profile-name demo-fargate-profile \
    --pod-execution-role-arn arn:aws:iam::463470985368:role/EKSFargatePodExecutionRole \
    --subnets subnet-0306cf3e80e146e92 \
